...
INSERT INTO `employeefired` VALUES (2,'Kirck','Navarro','FIRED'),(3,'Gerald','Baldon','FIRED'),(4,'Joriza','Oliva','FIRED');
...
INSERT INTO `productbrands` VALUES (1,'Razer'),(2,'Logitech'),(3,'Steel Series'),(4,'Alienware'),(5,'Corsair'),(6,'Kingston'),(7,'Lenovo'),(8,'HP'),(9,'ROG'),(10,'Red Dragon'),(11,'MSI');
...
INSERT INTO `products` VALUES (2,'Logitech G502','2-1-2023',1,'Out of Stock',2),(3,'Corsair K70 RGB','2-2-2023',2,'10',5),(4,'SteelSeries Apex','2-2-2023',2,'Out of Stock',3),(5,'Roccat Vulcan II Max','2-2-2023',2,'OUT OF STOCK',4),(6,'Roccat Vulcan II Max','2-2-2023',2,'5',4),(7,'Astro Gaming A10','2-3-2023',3,'1',10),(8,'Razer Barracuda X','2-3-2023',3,'5',1),(9,'Razer Blackshark V2','2-3-2023',3,'10',1),(10,'Asus ROG Zephyrus G15','2-4-2023',4,'2',9),(11,'Razer Sphenx','2-7-2023',6,'1',1),(12,'ROG ZEPHYRUS G14','PENDING ARRIVAL',4,'5',9),(13,'ROF AMONGUS GAMER','PENDING ARRIVAL',2,'7',10),(14,'Laptop','PENDING ARRIVAL',5,'OUT OF STOCK',10),(15,'Onikuma 19 Gaming Headset','PENDING ARRIVAL',8,'10',5);
...
INSERT INTO `producttypes` VALUES (1,'Gaming Mouse'),(2,'Gaming Keyboard'),(3,'Gaming Headset'),(4,'Gaming Laptop'),(5,'Bag'),(6,'Mousepad'),(7,'3A USB Type C Cable'),(8,'3A MIcro USB Cable'),(9,'Solid State Drive'),(10,'Hard Disk Drive');
...
-- Dump completed on 2023-05-01 18:53:32
